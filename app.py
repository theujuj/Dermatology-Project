...
def findMedicine(pred):
    if pred == 0:
        causes = """
Causes:
1. DNA mutations disrupt normal cell growth.
2. Excessive UV exposure damages DNA.
3. Genes provide instructions for cell growth.
4. Mutations lead to uncontrollable cell production.
5. Basal Cell Nevus Syndrome may contribute in rare cases.
"""
        return "fluorouracil" + causes
    elif pred == 1:
        return "Aldara"
    elif pred == 2:
